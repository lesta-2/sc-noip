#!/bin/bash
#shadowsocks-libev obfs install by lesta-2
...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/lesta-2/sc-noip/main/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/lesta-2/sc-noip/main/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/lesta-2/sc-noip/main/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/lesta-2/sc-noip/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
